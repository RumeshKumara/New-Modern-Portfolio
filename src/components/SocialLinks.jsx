...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/rumesh-kumara-166bb72a5",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rumesh884",
    icon: Instagram,
    url: "https://www.instagram.com/rumesh884/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@RumeshKumara",
    icon: Github,
    url: "https://github.com/RumeshKumara",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@rumeshkumara43",
    color: "black",
    ...
    <div className="w-full p-6 py-8 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="relative flex items-center justify-between p-4 overflow-hidden transition-all duration-500 border rounded-lg group bg-white/5 border-white/10 hover:border-white/20"
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="relative flex items-center justify-center">
              <div
                className="absolute inset-0 transition-all duration-500 rounded-md opacity-20 group-hover:scale-110 group-hover:opacity-30"
          ...
          {/* External Link */}
          <ExternalLink className="relative w-5 h-5 text-gray-500 transition-all duration-300 transform -translate-x-1 opacity-0 group-hover:text-white group-hover:opacity-100 group-hover:translate-x-0" />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {[instagram, youtube].map((link) => (
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div
                  className="absolute inset-0 transition-all duration-500 rounded-lg opacity-20 group-hover:scale-125 group-hover:opacity-30"
              ...
              <ExternalLink className="w-4 h-4 ml-auto text-gray-500 transition-all duration-300 transform -translate-x-2 opacity-0 group-hover:text-white group-hover:opacity-100 group-hover:translate-x-0" />
